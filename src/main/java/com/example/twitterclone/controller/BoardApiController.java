...
public class BoardApiController {
    ...
    @PostMapping("/board")
    public ResponseEntity insertBoard(@Validated @RequestBody BoardDTO boardDTO, BindingResult bindingResult){
        ...
        if(board.getId() == null){
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("데이터베이스 오류");
        }
